...
- **In Local Development:** Vite's development server is configured to automatically proxy requests made to `/graphql` to the local backend running at `http://localhost:4000`. Just ensure the backend is running locally.
